  ...
  switch (theme) {
    ...
    case 'light':
      return {
        ...
        buttonRing: 'ring-orange-400/50',
        tabBg: 'bg-zinc-100',
        proteinColor: 'text-red-500',
        carbsColor: 'text-amber-500',
        fatColor: 'text-blue-500',
        calColor: 'text-orange-500',
        proteinBar: 'bg-red-500',
        carbsBar: 'bg-amber-500',
        fatBar: 'bg-blue-500',
        barBg: 'bg-zinc-200',
        ...
        today: 'bg-zinc-100 text-orange-500 ring-1 ring-orange-400/50',
    ...
    default: // dark
      return {
        ...
        icon: 'text-orange-500',
        selected: 'bg-orange-500 text-white',
        today: 'bg-zinc-800 text-orange-400 ring-1 ring-orange-500/50',
